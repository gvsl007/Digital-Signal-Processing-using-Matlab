...
ylabel('Gain in dB');
title('FIR Highpass Using Rectangular Window');
axis([0 1 -100 10]);
...
xlabel('Normalized Frequency');
ylabel('Gain in dB');
title('FIR Highpass Using Triangular Window');
axis([0 1 -100 10]);
...
xlabel('Normalized Frequency');
ylabel('Gain in dB');
title('FIR Highpass Using Hamming Window');
axis([0 1 -100 10]);
...
xlabel('Normalized Frequency');
ylabel('Gain in dB');
title('FIR Highpass Using Hanning Window');
axis([0 1 -100 10]);
...
xlabel('Normalized Frequency');
ylabel('Gain in dB');
title('FIR Highpass Using Blackman Window');
axis([0 1 -100 10]);
...
xlabel('Normalized Frequency');
ylabel('Gain in dB');
title('FIR Highpass Using Kaiser Window');
axis([0 1 -100 10]);
